...
(function() {
  ...
  H5.Charts.Container = (function() {
    ...
    Container.prototype._createContainer = function() {
      var addBtn, addIcon, boxContent, boxHeader, boxTable, boxTitle, closeBtn, closeIcon, data, delBtn, delIcon, exportBtn, exportIcon, formBtn, key, leftBtn, leftCtrl, leftIcon, maxBtn, maxIcon, minBtn, minIcon, name, options, pipeline, rightBtn, rightCtrl, rightIcon, select, tableBtn, tableIcon, value, _ref, _ref1;
